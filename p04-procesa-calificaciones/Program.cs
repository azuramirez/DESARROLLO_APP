//Procesa calificaciones introducidas por el usuario, calcula suma y promedio
...
do{
  ...
  do{
      Console.Write("Calificación ? "); cal = float.Parse(Console.ReadLine());
      if(cal!=666) {
         suma+=cal;
         n++;
      }
...
Console.WriteLine($"Pomedio general de la clase {promgral}");
