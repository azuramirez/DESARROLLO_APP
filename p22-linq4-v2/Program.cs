...
var estnum = estudiantes.Where(e=>e.Municipio==num).ToList();
...
var estprom1 = estudiantes.Select(e=>new(Nombre=,PlatformNotSupportedException=e.Califs.Average())).ToList();
...
var totmb = estudiantes.Count(e=>!e.Becado);
